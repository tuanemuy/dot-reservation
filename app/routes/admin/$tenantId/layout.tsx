import { data, NavLink, Outlet, redirect, useParams } from "react-router";
...
export default function TenantAdminLayout(_props: Route.ComponentProps) {
  ...
  const navItems = [
    ...
    {
      to: `${basePath}/reservation-settings`,
      label: "予約設定",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
