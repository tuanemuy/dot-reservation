...
1. トップページにアクセス
2. 一覧からメニューを選択
3. スタッフを選択（任意・管理者設定により省略可）
4. カレンダーから希望日時を選択（スタッフの勤務時間を考慮して表示）
...
1. トップページにアクセス
2. メニュー選択
3. スタッフ選択（任意・管理者設定により省略可）
4. 日時選択（スタッフの勤務時間を考慮して表示）
5. ログイン（SSO/Email）
6. 確認画面（会員情報は登録済み）
7. 予約を確定
8. 確認メールを受信
